...
def send_welcome_email(user_data):
    ...
    <p style="color:#555;line-height:1.6;">Thanks for signing up! Your profile is saved and ready to go.
    Here is how the app works and some tips to get the best results.</p>
    </td></tr>
    ...
    for positions matching your preferences. Each listing is then
    <b>graded by AI</b> (Google Gemini) against your resume and criteria on a 1-5 star scale.
    Only the best matches (3+ stars) make it to your daily email or instant scan results.</p>
    </td></tr>
    ...
    <tr><td><b>Location</b></td><td>""" + str(location) + """</td></tr>
    <tr style="background:#f8f9fa;"><td><b>Min Salary</b></td><td>$""" + f"{min_salary:,}" + """</td></tr>
    </table>
    </td></tr>
