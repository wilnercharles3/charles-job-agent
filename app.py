...
if submitted:
      if not name or not email:
        ...
        try:
                      ...
                      st.balloons()
                      try:
                                        send_welcome_email(name, email, titles, location)
                                        ...
                                        with st.spinner("Fetching jobs from 5 job boards... (this may take 15-30 seconds)"):
                                                          try:
                                                                        ...
                                                                        if raw_jobs:
                                                                            ...
                                                                            jobs = []
                                                                        if not jobs:
                                                                                          st.warning("No jobs found. Try broader titles (e.g. 'Python Developer' instead of 'Entry Level Python Programmer') or add more title variations separated by commas.")
                                                                        else:
